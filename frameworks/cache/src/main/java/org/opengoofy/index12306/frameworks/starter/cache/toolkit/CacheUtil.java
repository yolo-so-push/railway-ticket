...
public final class CacheUtil {
    ...
    public static String buildKey(String... keys){
        Stream.of(keys).forEach(e-> Optional.ofNullable(Strings.emptyToNull(e)).orElseThrow(()->new RuntimeException("构建缓存key不允许为空")));
     ...
     * @return
     */
    public static boolean isNullOfBlank(Object cacheVal){
