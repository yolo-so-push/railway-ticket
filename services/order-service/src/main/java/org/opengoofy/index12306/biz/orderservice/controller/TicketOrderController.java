...
import org.opengoofy.index12306.frameworks.starter.web.Results;
...
public class TicketOrderController {
     ...
     *
     */
    @GetMapping("/api/order-service/order/ticket/repeat")
    public Result<List<String>> repeatTicketQuery(@RequestBody TicketPurchaseTicketRepeatQueryDTO requestParam){
        return Results.success(orderService.repeatTicketQuery(requestParam));
    }
}
