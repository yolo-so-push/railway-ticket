...
public interface UserRemoteService {
     ...
     * 根据乘车人id查询乘车人
     */
    @GetMapping("/api/user-service/actual/query/byId")
    Result<List<PassengerActualRespDTO>> queryPassengerByPassengerIds(@RequestParam("username") String username, @RequestParam("ids") List<Long> ids );
