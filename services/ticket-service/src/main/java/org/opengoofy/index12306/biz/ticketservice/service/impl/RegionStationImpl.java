...
public class RegionStationImpl implements RegionStationService {
    ...
    public List<RegionStationQueryRespDTO> listRegionStation(RegionStationQueryReqDTO requestParam) {
        ...
        LambdaQueryWrapper<RegionDO> queryWrapper=switch (requestParam.getQueryType()){
            ...
            default -> throw new ClientException("查询失败，请求检查查询参数是否正确");
        };
        return safeGetRegionStation(key,()->{
    ...
    private List<RegionStationQueryRespDTO> safeGetRegionStation(String key, CacheLoader<String> loader, String name) {
        ...
        String lockKey=LOCK_QUERY_REGION_STATION_LIST+name;
